...
% README, lectures/L09/exercises/test/README.md. The solution to the code is in the
% repository.
...
\textbf{How to check your work.} The test suite in \file{lectures/L09/exercises/test}
...
\label{c9:ex:10}
The test suite is available in \file{lectures/L09/exercises/test}. It's cumulative: it
...
The test suite's README, \file{lectures/L09/exercises/test/README.md}, has more
information.
