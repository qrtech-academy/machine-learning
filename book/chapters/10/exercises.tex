...
\textbf{How to check your work.} The test suite in \file{lectures/L10/exercises/test}
...
\label{c10:ex:9}
The final test suite is available in \file{lectures/L10/exercises/test}. It's cumulative:
...
\end{itemize}
The test suite's README, \file{lectures/L10/exercises/test/README.md}, has more
