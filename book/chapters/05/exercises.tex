...
\file{lectures/L05/appendix/exercises} in the companion repository. Set~1 declares the
...
\file{lectures/L05/appendix/exercises/test}, and Exercise~\ref{c5:ex:16} runs it. It's cumulative:
...
\label{c5:ex:16}
The final test suite is available in \file{lectures/L05/appendix/exercises/test}. It's cumulative:
it carries the stub and network tests from Chapter~\ref{c4:ch:network} over unchanged and adds unit
...
The test suite's README, \file{lectures/L05/appendix/exercises/test/README.md}, has more
