...
The tests read those, then redo the convolution the long way round - build the padded matrix, walk
the window, multiply and sum - and compare against what the layer produced. So the expected values
